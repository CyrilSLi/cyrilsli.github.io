...
Some of my other technical projects include:
...
- [transit-trackers](https://github.com/CyrilSLi/transit-trackers) - Small Python scripts to track interesting transit vehicles by fleet number
- [yt-localhost-iframe](https://github.com/CyrilSLi/yt-localhost-iframe) - Play YouTube videos ad-free using an iframe embed served from localhost

I also write a variety of userscripts and publish them on [GreasyFork](https://greasyfork.org/en/users/1422227-cyrilsli).